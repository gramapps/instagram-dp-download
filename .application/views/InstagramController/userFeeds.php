...
<div class="page">
	<div class="centered">
		...
		<div class="content">
			...
			<p>If you're looking for a safe and reliable way to view and download content from Instagram profiles,
				then <?= $_SERVER['CI_APP_SHORT_NAME'] ?> is the
				tool for you.</p>
			...
			<p>With the endless amount of creative and entertaining content, some users want to share it outside of Instagram or save
				their favorite content for offline viewing. <?= $_SERVER['CI_APP_SHORT_NAME'] ?> will allow you to save any public content
